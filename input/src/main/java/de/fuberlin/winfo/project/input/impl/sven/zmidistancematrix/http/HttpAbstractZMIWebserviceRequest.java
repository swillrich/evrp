...
public abstract class HttpAbstractZMIWebserviceRequest {
	...
	public HttpAbstractZMIWebserviceRequest() {
	...
	public HttpAbstractZMIWebserviceRequest execute() throws MalformedURLException, IOException {
		...
		this.zmiEdges = ZMIJsonConverter.deserializeJSON(fileInputStream, null);
